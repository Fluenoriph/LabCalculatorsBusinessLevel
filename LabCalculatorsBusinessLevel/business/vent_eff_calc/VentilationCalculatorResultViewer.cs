// * Файл "VentilationCalculatorResultViewer.cs": реализация вывода в консоль, результата калькулятора по вентиляции. *

using VentilationCalculatorData;


sealed class VentilationCalculatorResultViewer : BaseResultViewer<double, List<string>>
{

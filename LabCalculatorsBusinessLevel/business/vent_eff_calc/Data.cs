// * Файл "Data.cs": пространство имен "VentilationCalculatorData" - данные для калькулятора по вентиляции. *

namespace VentilationCalculatorData;


// Названия параметров.
// Основные и для разного типа отверстия.
...
// Константы для формулы рассчета.
...
// Границы диапазонов валидации входных параметров.
